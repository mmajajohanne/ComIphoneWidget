...
loosers_response = requests.get(loosers_url) #henter innholdet fra URL
loosers_page = BeautifulSoup(loosers_response.text, 'html.parser') #finner data jeg er interessert i (ticker symbol, name, and percentage)
